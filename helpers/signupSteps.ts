export type FieldType = "text" | "password" | "number" | "review" | "email"
...
export const signupSteps: CurrentStep[] = [
  {
    ...
    fields: [
      ...
      { name: "email", label: "Email", type: "email", inputType: "email-address", required: true, placeholder: "e.g. johndoe@email.com", error: false },
      { name: "password", label: "Password", type: "password", inputType: "default", required: true, placeholder: "At least 8 characters", error: false },
      { name: "confirmPassword", label: "Re-type Password", type: "password", inputType: "default", required: true, placeholder: "Re-enter your password", error: false },
    ],
  },
  {
    step: 2,
